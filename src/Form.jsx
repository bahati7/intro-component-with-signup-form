...
const Form = () => {
  ...
  return (
    <div>
      <section id="hero">
        <div className="container flex flex-col md:flex-row md:px-24 px-auto justify-center items-center mx-auto mt-10 space-y-0 md:space-y-0">
          <div className="flex flex-col mb-16  justify-center  space-y-12 md:w-1/2 w-80 text-white">
            <h1
          ...
          <div className="md:w-1/2 w-80 flex flex-col items-center md:p-8 p-2">
            <button
              type="submit"
